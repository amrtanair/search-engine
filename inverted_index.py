...
def generate_inverted_index(tokens, document):
    inverted_index = {}
...
def merge_inverted_index(child_inverted_index, mother_inverted_index, doc_id):
...
def driver(urls):
    ...
    for i,url in enumerate(urls):
        ...
        inverted_index = generate_inverted_index(tokens, document)
        mother_inverted_index = merge_inverted_index(inverted_index, mother_inverted_index, i)
    print(mother_inverted_index)
